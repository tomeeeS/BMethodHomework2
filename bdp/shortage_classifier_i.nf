...
THEORY ListSubstitutionX IS
  Expanded_List_Substitution(Implementation(shortage_classifier_i),IsOnShortage)==(CurrentStocks: 1..5 --> 0..4000 & ii: dom(CurrentStocks) & MaxStocks: 1..5 --> 0..4000 & Shortages: 1..5 --> BOOL & NewCurrentStock: 0..4000 & !xx.(xx: dom(Shortages|>{TRUE}) => CurrentStocks(xx)<MaxStocks(xx)/2) & !xx.(xx: dom(CurrentStocks) & CurrentStocks(xx)<MaxStocks(xx)/2 => xx: dom(Shortages|>{TRUE})) | NewCurrentStock<MaxStocks(ii)/2 ==> (res:=Shortages;(ii: dom(res) | res:=res<+{ii|->TRUE})) [] not(NewCurrentStock<MaxStocks(ii)/2) ==> (res:=Shortages;(ii: dom(res) | res:=res<+{ii|->FALSE}));(assert(!xx.(xx: dom({ii}<<|Shortages) => res(xx) = Shortages(xx)) & !xx.(xx: dom({ii}<<|(CurrentStocks<+{ii|->NewCurrentStock})) => (CurrentStocks<+{ii|->NewCurrentStock})(xx) = CurrentStocks(xx)) & {xx | xx: dom(CurrentStocks) & (CurrentStocks<+{ii|->NewCurrentStock})(xx)<MaxStocks(xx)/2} = {xx | xx: dom(CurrentStocks) & CurrentStocks(xx)<MaxStocks(xx)/2} & dom({ii}<<|Shortages|>{TRUE}) = {xx | xx: dom({ii}<<|CurrentStocks<+{ii|->NewCurrentStock}) & CurrentStocks(xx)<MaxStocks(xx)/2} & (NewCurrentStock<MaxStocks(ii)/2 => res(ii) = TRUE) & (not(NewCurrentStock<MaxStocks(ii)/2) => res(ii) = FALSE) & dom(Shortages<+{ii|->TRUE}|>{TRUE}) = dom({ii}<<|Shortages|>{TRUE})\/{ii} & Shortages<+{ii|->FALSE} = {ii}<<|Shortages\/{ii|->FALSE} & (Shortages<+{ii|->FALSE} = {ii}<<|Shortages\/{ii|->FALSE} => dom(Shortages<+{ii|->FALSE}|>{TRUE}) = dom({ii}<<|Shortages|>{TRUE}))) | !xx.(xx: dom({ii}<<|Shortages) => res(xx) = Shortages(xx)) & !xx.(xx: dom({ii}<<|(CurrentStocks<+{ii|->NewCurrentStock})) => (CurrentStocks<+{ii|->NewCurrentStock})(xx) = CurrentStocks(xx)) & {xx | xx: dom(CurrentStocks) & (CurrentStocks<+{ii|->NewCurrentStock})(xx)<MaxStocks(xx)/2} = {xx | xx: dom(CurrentStocks) & CurrentStocks(xx)<MaxStocks(xx)/2} & dom({ii}<<|Shortages|>{TRUE}) = {xx | xx: dom({ii}<<|CurrentStocks<+{ii|->NewCurrentStock}) & CurrentStocks(xx)<MaxStocks(xx)/2} & (NewCurrentStock<MaxStocks(ii)/2 => res(ii) = TRUE) & (not(NewCurrentStock<MaxStocks(ii)/2) => res(ii) = FALSE) & dom(Shortages<+{ii|->TRUE}|>{TRUE}) = dom({ii}<<|Shortages|>{TRUE})\/{ii} & Shortages<+{ii|->FALSE} = {ii}<<|Shortages\/{ii|->FALSE} & (Shortages<+{ii|->FALSE} = {ii}<<|Shortages\/{ii|->FALSE} => dom(Shortages<+{ii|->FALSE}|>{TRUE}) = dom({ii}<<|Shortages|>{TRUE})) ==> skip));
  List_Substitution(Implementation(shortage_classifier_i),IsOnShortage)==(IF NewCurrentStock<MaxStocks(ii)/2 THEN res:=Shortages;res(ii):=TRUE ELSE res:=Shortages;res(ii):=FALSE END;ASSERT !xx.(xx: dom({ii}<<|Shortages) => res(xx) = Shortages(xx)) & !xx.(xx: dom({ii}<<|(CurrentStocks<+{ii|->NewCurrentStock})) => (CurrentStocks<+{ii|->NewCurrentStock})(xx) = CurrentStocks(xx)) & {xx | xx: dom(CurrentStocks) & (CurrentStocks<+{ii|->NewCurrentStock})(xx)<MaxStocks(xx)/2} = {xx | xx: dom(CurrentStocks) & CurrentStocks(xx)<MaxStocks(xx)/2} & dom({ii}<<|Shortages|>{TRUE}) = {xx | xx: dom({ii}<<|CurrentStocks<+{ii|->NewCurrentStock}) & CurrentStocks(xx)<MaxStocks(xx)/2} & (NewCurrentStock<MaxStocks(ii)/2 => res(ii) = TRUE) & (not(NewCurrentStock<MaxStocks(ii)/2) => res(ii) = FALSE) & dom(Shortages<+{ii|->TRUE}|>{TRUE}) = dom({ii}<<|Shortages|>{TRUE})\/{ii} & Shortages<+{ii|->FALSE} = {ii}<<|Shortages\/{ii|->FALSE} & (Shortages<+{ii|->FALSE} = {ii}<<|Shortages\/{ii|->FALSE} => dom(Shortages<+{ii|->FALSE}|>{TRUE}) = dom({ii}<<|Shortages|>{TRUE})) THEN skip END)
END
&
